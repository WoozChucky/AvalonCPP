...
float av::Player::GetRotationAngle() const
{
    ...
    //
    //
    return static_cast<float>(atan2(this->m_rifle_.getPosition().y - this->m_mouse_position_.y, this->m_rifle_.getPosition().x - this->m_mouse_position_.x) * 180.f / 3.1428 - 90);
}
