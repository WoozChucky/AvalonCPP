...
namespace Avalon::Engine {
    ...
    enum VideoMode : U32 {
        Windowed = SDL_WINDOW_ALLOW_HIGHDPI,
        Borderless = SDL_WINDOW_BORDERLESS | SDL_WINDOW_ALLOW_HIGHDPI,
        Fullscreen = SDL_WINDOW_FULLSCREEN | SDL_WINDOW_ALLOW_HIGHDPI,
        FullscreenBorderless = SDL_WINDOW_FULLSCREEN_DESKTOP | SDL_WINDOW_ALLOW_HIGHDPI
    };
