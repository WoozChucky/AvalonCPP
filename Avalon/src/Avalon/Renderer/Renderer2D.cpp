...
namespace Avalon {
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<SubTexture2D>& subtexture, F32 tilingFactor, const glm::vec4& tintColor)
	{
	...
	void Renderer2D::DrawRotatedQuad(const glm::vec2& position, const glm::vec2& size, F32 rotation, const Ref<SubTexture2D>& subtexture, F32 tilingFactor, const glm::vec4& tintColor)
	{
